    ...
    <main className="min-h-screen flex flex-col items-center bg-black">
      ...
      <div className="flex flex-col space-y-4 ml-4">
        <ul className="text-2xl">
          ...
          <ul className="text-2xl">
            <li>
            <Link href="week-8" className="text-aqua-500 hover:underline">Week 8</Link>
            </li>
          </ul>
          <ul className="text-2xl">
            <li>
            <Link href="week-9" className="text-pink-500 hover:underline">Week 9</Link>
            </li>
          </ul>
          <ul className="text-2xl">
            <li>
            <Link href="week-10" className="text-brown-500 hover:underline">Week 10</Link>
            </li>
          </ul>
      </div>
    </main>
